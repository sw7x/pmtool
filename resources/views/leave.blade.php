            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="projectSelect clearfix form-group" style="margin-bottom: 15px;">
                            <label for="sel1">ww Select Project:</label>
                        </div>
    ...
    <div class="modal-dialog" style="width:800px;">
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <form action="/project/create" method="post" id="createProjectForm">
                    ...
                    <div class="form-group clearfix">
                        <div class="col-xs-6">
                            <label for="exampleFormControlTextarea1">PM</label>
