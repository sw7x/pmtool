                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body chat" id="chat-box">
                                <!-- chat item -->
                                <div class="item">
                                    <img src="{{ URL::to('public/assets') }}/img/user2-160x160.jpg" alt="user image" class="online">

                                    <p class="message">
                                        <a href="#" class="name">
                                            <small class="text-muted pull-right">2018/01/20 <i class="fa fa-clock-o"></i> 2:30 PM</small>
                                            Saman Rathnayake
                                        </a>
                                        Guys please start the project
                                    </p>
                                ...
                                <div class="item">
                                    ...
                                    <p class="message">
                                        <a href="#" class="name">
                                            <small class="text-muted pull-right">2018/01/20 <i class="fa fa-clock-o"></i> 4:15 PM</small>
                                            Tharaka Jayathilake
                                        </a>
                                        ok.. start planing
                                    </p>
                                ...
                                <div class="item">
                                    ...
                                    <p class="message">
                                        <a href="#" class="name">
                                            <small class="text-muted pull-right">2018/01/21 <i class="fa fa-clock-o"></i> 8:30PM</small>
                                            Dasun Perera
                                        </a>
                                        noted.. but wireframes need before start frontend develpment
                                    </p>
                                </div>
                                <!-- /.item -->
                            </div>
